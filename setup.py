...
setup(
    ...
    packages=["jx_sqlite","jx_sqlite.expressions","jx_base","jx_base.expressions",



              "jx_python","jx_python.expressions","jx_python.containers","jx_python.cubes","jx_python.lists","jx_python.namespace",
              "mo_collections","mo_dots","mo_files","mo_future","mo_imports","mo_json","mo_json_config","mo_kwargs","mo_logs",
              "mo_math","mo_sql","mo_testing","mo_threads","mo_times",
             "mo_times.vendor.dateutil.zoneinfo",
        "mo_times.vendor.dateutil",
        "mo_times.vendor",
        "mo_times"
, "pyLibrary",
              "pyLibrary.env",
